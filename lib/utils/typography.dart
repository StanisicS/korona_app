...
const TextStyle headlineTextStyle =
    TextStyle(fontSize: 44, color: kText, height: 1.2, fontFamily: fontFamily);

const TextStyle headlineSecondaryTextStyle =
    TextStyle(fontSize: 28, color: kText, height: 1.2, fontFamily: fontFamily);

const TextStyle bodyTextStyle =
    TextStyle(fontSize: 16, color: kText, height: 1.5, fontFamily: 'Roboto');
